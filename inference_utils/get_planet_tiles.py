"""
Script to get all the tiles from available scenes, aoi and date range for Planetscopes or Skysat
...
def stats(geometry, collections, start_date, end_date, cc, PL_API_KEY):
    ...
    result = requests.post('https://api.planet.com/data/v1/stats',
