...
for tif in tif_tiles:
    ...
    cmd = f"python3 utils_convert_tfrecords_jpg.py --label_input={labels_dir}/{basename}/labels.npz --data_dir={labels_dir}/tf_records --tiles_dir={labels_dir}/{basename}/tiles --pbtxt=data/marine_debris.pbtxt --record_name {basename}"
